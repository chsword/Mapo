...
Navigator.init = function () {
    ...
    $("#navigation_eye").bind("mousedown",
        function (downE) {
            ...
            $(document).bind("mousemove.navigator",
                function (moveE) {
            ...
            $(document).bind("mouseup.navigator",
                function (moveE) {
...
Navigator.draw = function () {
    ...
    this.drawNavigationTimeout = setTimeout(function() {
            ...
            ctx.restore();
            Navigator.setView();
            Navigator.drawNavigationTimeout = null;
        },
        100);
};
/**
